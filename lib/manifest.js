(function () {
  ...
  window.__BRAND__ = {
    ...
    framePresets: [
      ...
      { key: "doble-barra",   label: "Doble barra",   icon: "⬕" },
      { key: "cinta-esquina", label: "Cinta esquina", icon: "◹" },
      { key: "burbuja",       label: "Burbuja",       icon: "💬" },
      { key: "marco-completo",label: "Marco completo",icon: "▧" },
      { key: "esquinas",      label: "Esquinas",      icon: "⌐" },
      { key: "ticket",        label: "Ticket",        icon: "🎫" },
      { key: "medalla",       label: "Medalla",       icon: "🏅" },
      { key: "ventana",       label: "Ventana web",   icon: "🖥️" },
      { key: "recibo",        label: "Recibo",        icon: "🧾" },
      { key: "etiqueta",      label: "Etiqueta viaje",icon: "🏷️" },
      { key: "sello-postal",  label: "Sello postal",  icon: "📮" },
      { key: "post-it",       label: "Nota adhesiva", icon: "📝" },
      { key: "banderin",      label: "Banderín",      icon: "🚩" },
      { key: "disco",         label: "Disco de vinilo",icon: "💿" },
      { key: "nube",          label: "Nube",          icon: "☁️" }
    ],

    frameBorders: [
      { key: "solido",   label: "Sólido",   icon: "▬" },
      { key: "punteado", label: "Punteado", icon: "┄" },
      { key: "ondulado", label: "Ondulado", icon: "〰" }
    ],

    frameIcons: [
      { key: "ninguno",   label: "Ninguno",    emoji: "" },
      { key: "estrella",  label: "Estrella",   emoji: "⭐" },
      { key: "corazon",   label: "Corazón",    emoji: "❤️" },
      { key: "hoja",      label: "Hoja",       emoji: "🍃" },
      { key: "copo",      label: "Copo",       emoji: "❄️" },
      { key: "confeti",   label: "Confeti",    emoji: "🎉" },
      { key: "campana",   label: "Campana",    emoji: "🔔" },
      { key: "avion",     label: "Avión",      emoji: "✈️" },
      { key: "carrito",   label: "Carrito",    emoji: "🛒" },
      { key: "bolsa",     label: "Bolsa",      emoji: "🛍️" },
      { key: "compu",     label: "Computador", emoji: "💻" },
      { key: "cafe",      label: "Café",       emoji: "☕" },
      { key: "pata",      label: "Mascota",    emoji: "🐾" },
